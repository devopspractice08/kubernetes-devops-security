...
# Install Java 17 (Jenkins now requires Java 17 or higher)
apt install -y openjdk-17-jdk

# Add Jenkins key and repository (correct for 2025)
...
# Add Jenkins user to Docker group and allow passwordless sudo
